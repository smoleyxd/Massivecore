...
public class MigratorInventory004SkullCleanup extends MigratorRoot
{
	// -------------------------------------------- //
	// CONSTANTS
	// -------------------------------------------- //
	...
	private static final MigratorInventory004SkullCleanup i = new MigratorInventory004SkullCleanup();
	public static MigratorInventory004SkullCleanup get() { return i; }
	private MigratorInventory004SkullCleanup() { super(Inventory.class); }

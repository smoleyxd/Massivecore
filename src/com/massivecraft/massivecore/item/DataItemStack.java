...
public class DataItemStack implements Comparable<DataItemStack>
{
	...
	public static final String DEFAULT_ID = Material.AIR.name();
	public static final Integer DEFAULT_COUNT = 1;
	public static final Integer DEFAULT_DAMAGE = 0;
	public static final Map<String, Object> DEFAULT_PERSISTENTDATA = Collections.emptyMap();
	public static final String DEFAULT_NAME = "";
	public static final List<String> DEFAULT_LORE = Collections.emptyList();
	public static final Map<String, Integer> DEFAULT_ENCHANTS = Collections.emptyMap();
	public static final Integer DEFAULT_REPAIRCOST = 0;
	public static final String DEFAULT_TITLE = null;
	public static final String DEFAULT_AUTHOR = null;
	public static final Generation DEFAULT_GENERATION = null;
	public static final List<String> DEFAULT_PAGES = Collections.emptyList();
	public static final Integer DEFAULT_COLOR = Bukkit.getItemFactory().getDefaultLeatherColor().asRGB();
	public static final PS DEFAULT_LODESTONE = null;
	public static final Boolean DEFAULT_TRACKING_LODESTONE = false;
	public static final Boolean DEFAULT_SCALING = false;
	public static final Integer DEFAULT_MAP_COLOR = null;
	public static final String DEFAULT_MAP_NAME = null;
	public static final Integer DEFAULT_MAP_ID = null;
	public static final List<DataPotionEffect> DEFAULT_POTION_EFFECTS = Collections.emptyList();
	public static final ContainerGameProfile DEFAULT_GAMEPROFILE = null;
	public static final DataFireworkEffect DEFAULT_FIREWORK_EFFECT = null;
	public static final List<DataFireworkEffect> DEFAULT_FIREWORK_EFFECTS = Collections.emptyList();
	public static final Integer DEFAULT_FIREWORK_FLIGHT = 0;
	public static final Map<String, Integer> DEFAULT_STORED_ENCHANTS = Collections.emptyMap();
	public static final Boolean DEFAULT_UNBREAKABLE = false;
	public static final Set<String> DEFAULT_FLAGS = Collections.emptySet();
	public static final DyeColor DEFAULT_BANNER_BASE = null;
	public static final List<DataBannerPattern> DEFAULT_BANNER_PATTERNS = Collections.emptyList();
	public static final String DEFAULT_POTION = "water";
	public static final Map<Integer, DataItemStack> DEFAULT_INVENTORY = Collections.emptyMap();
	public static final Integer DEFAULT_POTION_COLOR = null;
	public static final TropicalFish.Pattern DEFAULT_FISH_PATTERN = null;
	public static final DyeColor DEFAULT_FISH_PATTERN_COLOR = null;
	public static final DyeColor DEFAULT_FISH_BODY_COLOR = null;
	public static final Map<Integer, DataItemStack> DEFAULT_CHARGEDPROJECTILES = Collections.emptyMap();
	public static final List<String> DEFAULT_RECIPES = Collections.emptyList();
	public static final List<DataItemStack> DEFAULT_BUNDLE = Collections.emptyList();
	public static final Axolotl.Variant DEFAULT_AXOLOTL_VARIANT = Axolotl.Variant.WILD;
	public static final Set<DataAttributeModifier> DEFAULT_ATTRIBUTE_MODIFIERS = Collections.emptySet();
	public static final String DEFAULT_MYTHIC_TYPE = null;

...
public final class ReflectionUtils {
	...
	public enum PackageType {
		...
		CRAFTBUKKIT_PERSISTENCE(CRAFTBUKKIT, "persistence"),
		...
		CRAFTBUKKIT_VERSION_BLOCK(CRAFTBUKKIT, "block"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_CHUNKIO(CRAFTBUKKIT, "chunkio"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_COMMAND(CRAFTBUKKIT, "command"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_CONVERSATIONS(CRAFTBUKKIT, "conversations"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_ENCHANTMENTS(CRAFTBUKKIT, "enchantments"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_ENTITY(CRAFTBUKKIT, "entity"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_EVENT(CRAFTBUKKIT, "event"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_GENERATOR(CRAFTBUKKIT, "generator"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_HELP(CRAFTBUKKIT, "help"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_INVENTORY(CRAFTBUKKIT, "inventory"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_MAP(CRAFTBUKKIT, "map"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_METADATA(CRAFTBUKKIT, "metadata"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_POTION(CRAFTBUKKIT, "potion"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_PERSISTENCE(CRAFTBUKKIT, "persistence"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_PROJECTILES(CRAFTBUKKIT, "projectiles"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_SCHEDULER(CRAFTBUKKIT, "scheduler"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_SCOREBOARD(CRAFTBUKKIT, "scoreboard"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_UPDATER(CRAFTBUKKIT, "updater"),
		@Deprecated(forRemoval = true)
		CRAFTBUKKIT_VERSION_UTIL(CRAFTBUKKIT, "util");

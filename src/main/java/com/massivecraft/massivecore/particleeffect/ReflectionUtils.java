...
public final class ReflectionUtils {
	...
	public enum PackageType {
		...
		MINECRAFT_NETWORK(MINECRAFT, "network"),
		MINECRAFT_NETWORK_CHAT(MINECRAFT_NETWORK, "chat"),
		MINECRAFT_NETWORK_PROTOCOL(MINECRAFT_NETWORK, "protocol"),
		MINECRAFT_NETWORK_PROTOCOL_GAME(MINECRAFT_NETWORK_PROTOCOL, "game"),
		MINECRAFT_SERVER(MINECRAFT, "server"),
		MINECRAFT_SERVER_LEVEL(MINECRAFT_SERVER, "level"),
		MINECRAFT_SERVER_NETWORK(MINECRAFT_SERVER, "network"),
		MINECRAFT_SERVER_VERSION(MINECRAFT_SERVER, getServerVersion()),
		MINECRAFT_WORLD(MINECRAFT, "world"),
		MINECRAFT_WORLD_ENTITY(MINECRAFT_WORLD, "entity"),
		MINECRAFT_WORLD_ENTITY_PLAYER(MINECRAFT_WORLD_ENTITY, "player"),
		MINECRAFT_WORLD_ITEM(MINECRAFT_WORLD, "item"),
		MINECRAFT_WORLD_LEVEL(MINECRAFT_WORLD, "level"),
		MINECRAFT_WORLD_LEVEL_ENTITY(MINECRAFT_WORLD_LEVEL, "entity"),
		CRAFTBUKKIT("org.bukkit.craftbukkit"),
		CRAFTBUKKIT_VERSION(CRAFTBUKKIT, getServerVersion()),
		CRAFTBUKKIT_VERSION_BLOCK(CRAFTBUKKIT_VERSION, "block"),
		CRAFTBUKKIT_VERSION_CHUNKIO(CRAFTBUKKIT_VERSION, "chunkio"),
		CRAFTBUKKIT_VERSION_COMMAND(CRAFTBUKKIT_VERSION, "command"),
		CRAFTBUKKIT_VERSION_CONVERSATIONS(CRAFTBUKKIT_VERSION, "conversations"),
		CRAFTBUKKIT_VERSION_ENCHANTMENTS(CRAFTBUKKIT_VERSION, "enchantments"),
		CRAFTBUKKIT_VERSION_ENTITY(CRAFTBUKKIT_VERSION, "entity"),
		CRAFTBUKKIT_VERSION_EVENT(CRAFTBUKKIT_VERSION, "event"),
		CRAFTBUKKIT_VERSION_GENERATOR(CRAFTBUKKIT_VERSION, "generator"),
		CRAFTBUKKIT_VERSION_HELP(CRAFTBUKKIT_VERSION, "help"),
		CRAFTBUKKIT_VERSION_INVENTORY(CRAFTBUKKIT_VERSION, "inventory"),
		CRAFTBUKKIT_VERSION_MAP(CRAFTBUKKIT_VERSION, "map"),
		CRAFTBUKKIT_VERSION_METADATA(CRAFTBUKKIT_VERSION, "metadata"),
		CRAFTBUKKIT_VERSION_POTION(CRAFTBUKKIT_VERSION, "potion"),
		CRAFTBUKKIT_VERSION_PERSISTENCE(CRAFTBUKKIT_VERSION, "persistence"),
		CRAFTBUKKIT_VERSION_PROJECTILES(CRAFTBUKKIT_VERSION, "projectiles"),
		CRAFTBUKKIT_VERSION_SCHEDULER(CRAFTBUKKIT_VERSION, "scheduler"),
		CRAFTBUKKIT_VERSION_SCOREBOARD(CRAFTBUKKIT_VERSION, "scoreboard"),
		CRAFTBUKKIT_VERSION_UPDATER(CRAFTBUKKIT_VERSION, "updater"),

...
public class Mixin extends Engine
{
	...
	private static final Map<String, String> NAME_MAP = new MassiveMap<>(
		...
		"118R1", "Minecraft 1.18.0 --> 1.18.2 [1_18_R1]",
		"118R1P", "Minecraft 1.18.0+ [1_18_R1+]",
		
		"119R1", "Minecraft 1.19.0 --> 1.19.3 [1_19_R1]",
		"119R1P", "Minecraft 1.19.0+ [1_19_R1+]",
		
		"120R1", "Minecraft 1.20.0 --> 1.20.1 [1_20_R1]",
		"120R1P", "Minecraft 1.20.0+ [1_20_R1+]",
		
		"120R2", "Minecraft 1.20.2 --> 1.20.3 [1_20_R2]",

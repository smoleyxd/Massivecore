...
public class MigratorInventory008GrassToShortGrass extends MigratorRoot
{
	// -------------------------------------------- //
	// CONSTANTS
	// -------------------------------------------- //
	...
	private static final MigratorInventory008GrassToShortGrass i = new MigratorInventory008GrassToShortGrass();
	public static MigratorInventory008GrassToShortGrass get() { return i; }
	private MigratorInventory008GrassToShortGrass()
	{
